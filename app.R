...
ui <- fluidPage(
    ...
    inputPanel(
        selectInput("Types", "Types:", c("Protective Put", "Covered Call", "Collar", "Bull Call", "Bear Call", "Straddle", "Butterfly")),
    ...
    mainPanel(
        tabsetPanel(type = "pills",
            tabPanel(title = "Protective Put"),
            tabPanel(title = "Covered Call"),
            tabPanel(title = "Collar"),
            tabPanel(title = "Bull Call"),
            tabPanel(title = "Bear Call"),
            tabPanel(title = "Straddle"),
            tabPanel(title = "Butterfly"))
...
server <- function(input, output) {
    ...
    dataInput <- reactive({
        ...
        ## source("http://faculty.ucr.edu/~girke/Documents/R_BioCond/My_R_Scripts/mortgage.R")
        ## Author: Thomas Girke
                                        #{{{
